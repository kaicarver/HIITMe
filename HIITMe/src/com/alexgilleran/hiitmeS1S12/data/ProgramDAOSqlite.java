...
package com.alexgilleran.hiitmeS1S12.data;
...
import com.alexgilleran.hiitmeS1S12.model.DatabaseModel;
...
import com.alexgilleran.hiitmeS1S12.model.ProgramMetaData;
...
public class ProgramDAOSqlite extends SQLiteOpenHelper implements ProgramDAO {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		Node ex;
		s = new Program("S1");
		s.getAssociatedNode().addChildExercise("Walk", minutesInMs(10), EffortLevel.EASY);
		ex = s.getAssociatedNode().addChildNode(6);
		ex.addChildExercise("Run", minutesInMs(2), EffortLevel.EASY);
		ex.addChildExercise("Walk", minutesInMs(1), EffortLevel.REST);
		saveProgram(s, db);
		s = new Program("S2");
		s.getAssociatedNode().addChildExercise("Walk", minutesInMs(10), EffortLevel.EASY);
		ex = s.getAssociatedNode().addChildNode(5);
		ex.addChildExercise("Run", minutesInMs(3), EffortLevel.EASY);
		ex.addChildExercise("Walk", minutesInMs(1), EffortLevel.REST);
		saveProgram(s, db);
		s = new Program("S3");
		s.getAssociatedNode().addChildExercise("Walk", minutesInMs(8), EffortLevel.EASY);
		ex = s.getAssociatedNode().addChildNode(4);
		ex.addChildExercise("Run", minutesInMs(4), EffortLevel.EASY);
		ex.addChildExercise("Walk", minutesInMs(1), EffortLevel.REST);
		saveProgram(s, db);
		s = new Program("S4");
		s.getAssociatedNode().addChildExercise("Walk", minutesInMs(6), EffortLevel.EASY);
		ex = s.getAssociatedNode().addChildNode(4);
		ex.addChildExercise("Run", minutesInMs(5), EffortLevel.EASY);
		ex.addChildExercise("Walk", minutesInMs(1), EffortLevel.REST);
		saveProgram(s, db);
		s = new Program("S5");
		ex = s.getAssociatedNode().addChildNode(2);
		ex.addChildExercise("Run", minutesInMs(6), EffortLevel.EASY);
		ex.addChildExercise("Walk", 90000, EffortLevel.REST);
		ex = s.getAssociatedNode().addChildNode(2);
		ex.addChildExercise("Run", minutesInMs(5), EffortLevel.EASY);
		ex.addChildExercise("Walk", minutesInMs(1), EffortLevel.REST);
		saveProgram(s, db);
		s = new Program("S6");
		ex = s.getAssociatedNode().addChildNode(2);
		ex.addChildExercise("Run", minutesInMs(8), EffortLevel.EASY);
		ex.addChildExercise("Walk", 90000, EffortLevel.REST);
		ex = s.getAssociatedNode().addChildNode(3);
		ex.addChildExercise("Run", minutesInMs(4), EffortLevel.EASY);
		ex.addChildExercise("Walk", minutesInMs(1), EffortLevel.REST);
		saveProgram(s, db);
		s = new Program("S7");
		s.getAssociatedNode().addChildExercise("Run", minutesInMs(12), EffortLevel.EASY);
		s.getAssociatedNode().addChildExercise("Walk", minutesInMs(2), EffortLevel.REST);
		s.getAssociatedNode().addChildExercise("Run", minutesInMs(10), EffortLevel.EASY);
		s.getAssociatedNode().addChildExercise("Walk", minutesInMs(2), EffortLevel.REST);
		s.getAssociatedNode().addChildExercise("Run", minutesInMs(8), EffortLevel.EASY);
		s.getAssociatedNode().addChildExercise("Walk", minutesInMs(2), EffortLevel.REST);
		saveProgram(s, db);
		s = new Program("S8");
		ex = s.getAssociatedNode().addChildNode(2);
		ex.addChildExercise("Run", minutesInMs(10), EffortLevel.EASY);
		ex.addChildExercise("Walk", minutesInMs(2), EffortLevel.REST);
		ex = s.getAssociatedNode().addChildNode(2);
		ex.addChildExercise("Run", minutesInMs(5), EffortLevel.EASY);
		ex.addChildExercise("Walk", minutesInMs(1), EffortLevel.REST);
		saveProgram(s, db);
		s = new Program("S9");
		s.getAssociatedNode().addChildExercise("Run", minutesInMs(15), EffortLevel.EASY);
		s.getAssociatedNode().addChildExercise("Walk", minutesInMs(2), EffortLevel.REST);
		ex = s.getAssociatedNode().addChildNode(3);
		ex.addChildExercise("Run", minutesInMs(5), EffortLevel.EASY);
		ex.addChildExercise("Walk", minutesInMs(1), EffortLevel.REST);
		saveProgram(s, db);
		s = new Program("S10");
		s.getAssociatedNode().addChildExercise("Run", minutesInMs(20), EffortLevel.EASY);
		s.getAssociatedNode().addChildExercise("Walk", minutesInMs(2), EffortLevel.REST);
		s.getAssociatedNode().addChildExercise("Run", minutesInMs(10), EffortLevel.EASY);
		s.getAssociatedNode().addChildExercise("Walk", minutesInMs(2), EffortLevel.REST);
		s.getAssociatedNode().addChildExercise("Run", minutesInMs(5), EffortLevel.EASY);
		s.getAssociatedNode().addChildExercise("Walk", minutesInMs(2), EffortLevel.REST);
		saveProgram(s, db);
		s = new Program("S11");
		s.getAssociatedNode().addChildExercise("Run", minutesInMs(25), EffortLevel.EASY);
		s.getAssociatedNode().addChildExercise("Walk", minutesInMs(2), EffortLevel.REST);
		ex = s.getAssociatedNode().addChildNode(2);
		ex.addChildExercise("Run", minutesInMs(5), EffortLevel.EASY);
		ex.addChildExercise("Walk", minutesInMs(1), EffortLevel.REST);
		saveProgram(s, db);
		s = new Program("S12");
		s.getAssociatedNode().addChildExercise("Run", minutesInMs(30), EffortLevel.EASY);
		s.getAssociatedNode().addChildExercise("Walk", minutesInMs(2), EffortLevel.REST);
		saveProgram(s, db);
	}
