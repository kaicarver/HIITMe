...
public class AutoResizeTextView extends TextView {
	private interface SizeTester {
		 ...
		 * @return an integer < 0 if after applying {@code suggestedSize} to text, it takes less space than
		 *         {@code availableSpace}, > 0 otherwise
		 */
	...
	/**
	 * Enables or disables size caching, enabling it will improve performance where you are animating a value inside
	 * TextView. This stores the font size against getText().length() Be careful though while enabling it as 0 takes
	 * more space than 1 on some fonts and so on.
	 * 
	 * @param enable
